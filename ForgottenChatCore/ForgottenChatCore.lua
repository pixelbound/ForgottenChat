...
function FC_OnLoad()
	...
	--Set up hooks
	hooksecurefunc("ContainerFrameItemButton_OnClick",FC_ContainerFrameItemButton_OnClick)
	...
	hooksecurefunc("QuestLogRewardItem_OnClick",FC_QuestLogRewardItem_OnClick)
	hooksecurefunc("LootButton_OnModifiedClick",FC_LootButton_OnModifiedClick)
